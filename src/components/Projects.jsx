...
const Projects = () => {
	return (
		<div
			name="projects"
			className="container px-5 py-24 md:py-48 flex justify-center mx-auto"
		>
			<div className="flex flex-col">
				<h1 className="inline-block text-4xl pl-5 md:ml-60 text-slate-300 font-bold pb-3 underline decoration-slate-600 transition hover:text-[#00df9a] cursor-pointer">
					Projects
				</h1>
				<div className="flex flex-wrap md:justify-center -m-4">
					...
					<div className="p-4 lg:w-1/3 transform transition duration-500 hover:scale-105">
						<div className="h-full bg-slate-600 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative border border-slate-300">
							...
							<p className="leading-relaxed mb-3 text-gray-400">
								lightweight markup language with plain text formatting syntax using the marked
								npm. Used React and Bootstrap.
							</p>
							<a
